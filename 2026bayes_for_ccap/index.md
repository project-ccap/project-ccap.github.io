...
* [Generalizability Crisi: Yarkoni (2022)](2022Yarkoni_ja/){:target="_blank"} The Generalizability Crisis, Behavioral and Brain Sciences, 45, e1, 1–37, DOI:10.1017/S0140525X2000168X

上の解決策としての **線形混合効果モデル** (LME: Linear Mixed Effect Modeling, 文献によっては LMEM とも表記される) <br/><br/>
CCAP メンバとしては，下記のような文献の親密度が高いはず：
