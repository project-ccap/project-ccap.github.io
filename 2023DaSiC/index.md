...
1. 13:30-14:10 趣旨説明：寺尾康 (静岡県立大学)
   * データの紹介1：[健常者の言い誤り 寺尾康](2023session1_DaSIC.pdf){:target="_blank"}
   * [発話についての認知モデルの変遷 寺尾康](DaSic_Sec3発話認知モデルの変遷2.pdf){:target="_blank"}:
...
2. 14:10-14:50 [機械学習からみた言語モデルの鏡 浅川伸一 (東京女子大学)](2023DaSIC02Asakawa_Intro_ML){:target="_blank"}:
